...
insert into m_sub values (NULL,99,'Alimony Payment',0,0,9901, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,99,'Beauty & Barber',0,0,9902, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,99,'Charitable Payment',0,0,9903, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,99,'Clothing',0,0,9904, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,99,'Dining Out',0,0,9905, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,99,'Expense Accounts/Membership',0,0,9906, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,99,'Garbage & Recycle',0,0,9907, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,99,'Gifts',0,0,9908, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,99,'Health Club',0,0,9909, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,99,'Hobbies/Leisure',0,0,9910, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,99,'Loan',0,0,9911, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,99,'Lottery',0,0,9912, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,99,'Miscellaneous',0,0,9913, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,99,'Mortgage Payment',0,0,9914, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,99,'Newspaper',0,0,9915, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,99,'Pet Care',0,0,9916, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,99,'Remittance',0,0,9917, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,99,'Travel/Vacation',0,0,9918, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,99,'Go Home',0,0,9919, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,901,'Automobile',0,0,90101, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,901,'Commercial',0,0,90102, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,901,'Employment',0,0,90103, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,901,'Health',0,0,90104, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,901,'Homeowner''s/Renter''s',0,0,90105, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,901,'Life',0,0,90106, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,902,'Real Estate Taxes',0,0,90201, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,902,'Resident Tax',0,0,90202, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,902,'Social Security Tax',0,0,90203, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,902,'Withholding Tax',0,0,90204, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,903,'Corporate Pension',0,0,90301, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,903,'Employee Pension',0,0,90302, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,903,'National Pension',0,0,90303, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,951,'Wages & Salary',0,0,95101, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,951,'Overtime',0,0,95102, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,951,'Bonus',0,0,95103, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,951,'Transportation',0,0,95104, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,951,'Travel allowance',0,0,95105, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,951,'Daily allowance',0,0,95106, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,952,'Child Support Received',0,0,95201, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,952,'Gifts Received',0,0,95202, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,952,'Lotteries',0,0,95203, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,952,'Other',0,0,95204, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,952,'State & Local Tax Refund',0,0,95205, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,953,'Pensions & Annuities',0,0,95301, datetime('now'), datetime('now'), 0);
insert into m_sub values (NULL,953,'Social Security Benefits',0,0,95302, datetime('now'), datetime('now'), 0);
