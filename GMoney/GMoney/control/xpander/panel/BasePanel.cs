...
using Money.control.xpander.panel.color;
using Money.control.xpander.eventArgs;
...
namespace Money.control.xpander.panel
{
    ...
    public class BasePanel : ScrollableControl, IPanel
	{
        ...
        private Color m_colorInnerBorder;
            ...
            set
            {
                if (value < Constants.CaptionMinHeight)
                {
                    throw new InvalidOperationException(
                        ...
                        Constants.IDS_InvalidOperationExceptionInteger, value, "CaptionHeight", Constants.CaptionMinHeight));
                }
        ...
        public void SetPanelProperties(PanelColors panelColors)
        {
            if (panelColors == null)
            {
                throw new ArgumentException(
                    string.Format(
                    System.Globalization.CultureInfo.CurrentUICulture,
                    Constants.IDS_ArgumentException,
                    "panelColors"));
            }
